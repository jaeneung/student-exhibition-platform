...
const ko = {
  ...
  form: {
    ...
    videoRelayUploading: "동영상이 커서 자동으로 업로드하고 있어요... {progress}%",
    videoRelaySuccess: "동영상이 자동으로 업로드되어 이 링크가 채워졌어요. 그대로 제출하시면 돼요.",
    videoRelayError:
      "동영상 자동 업로드에 실패했어요. 잠시 후 다시 시도하거나, 유튜브 등에 올린 뒤 '🔗 링크 입력'으로 그 주소를 제출해 주세요.",
...
const en: Dictionary = {
  ...
  form: {
    ...
    videoRelayUploading: "Your video is large, so it's being uploaded automatically... {progress}%",
    videoRelaySuccess: "Your video was uploaded automatically and this link was filled in — you can submit as-is.",
    videoRelayError:
      "Automatic video upload failed. Try again shortly, or upload it to YouTube or similar and submit that link instead using '🔗 Enter a Link'.",
