  ...
  return (
    <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center gap-6 px-4 py-16 sm:px-6">
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <h1 className="text-2xl font-bold">{sa.loginTitle}</h1>
        <p className="text-sm text-zinc-600 dark:text-zinc-400">{sa.loginSubtitle}</p>
      </div>
      <StudentAuthForm dict={dict} mode="login" action={studentLoginAction} next={next} />
    </div>
  );
}
